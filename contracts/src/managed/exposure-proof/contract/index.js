...
class _ExposureSummary_0 {
  ...
  fromValue(value_0) {
    return {
      active_count: _descriptor_0.fromValue(value_0),
      total_exposure: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.active_count).concat(_descriptor_1.toValue(value_0.total_exposure));
  }
}
...
class _PrivateLoanRecord_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment().concat(_descriptor_5.alignment())));
  }
  fromValue(value_0) {
    return {
      lender_id: _descriptor_2.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.lender_id).concat(_descriptor_1.toValue(value_0.amount).concat(_descriptor_2.toValue(value_0.nonce).concat(_descriptor_5.toValue(value_0.status))));
  }
}
...
export class Contract {
      ...
      register_loan: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('register_loan',
                                     ...
                                     'exposure-proof.compact line 91 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(borrower_id_0).concat(_descriptor_2.toValue(lender_id_0).concat(_descriptor_1.toValue(amount_0).concat(_descriptor_2.toValue(nonce_0)))),
            alignment: _descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment())))
          },
          output: undefined,
          publicTranscript: [],
      ...
      prove_exposure_within_limit: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('prove_exposure_within_limit',
                                     'argument 1 (as invoked from Typescript)',
                                     'exposure-proof.compact line 105 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(max_lender_count_0).concat(_descriptor_1.toValue(max_total_exposure_0)),
      ...
      close_loan: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('close_loan',
                                     'argument 1 (as invoked from Typescript)',
                                     'exposure-proof.compact line 129 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(loan_commitment_0).concat(_descriptor_2.toValue(nonce_0)),
  ...
  _get_borrower_id_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('get_borrower_id',
                                 'return value',
                                 'exposure-proof.compact line 34 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _compute_loan_commitment_0(borrower_id_0, lender_id_0, amount_0, nonce_0) {
    return this._persistentHash_0([borrower_id_0,
                                   ...
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        amount_0,
                                                                        'exposure-proof.compact line 47 char 5'),
                                   nonce_0]);
  }
  _compute_nullifier_0(commitment_0, nonce_0) {
    return this._persistentHash_1([commitment_0, nonce_0]);
  }
  _process_loan_item_0(context, partialProofData, acc_0, loan_0, borrower_id_0)
  {
    if (loan_0.status === 1) {
      let t_0;
      __compactRuntime.assert((t_0 = loan_0.amount, t_0 > 0n),
                              'Active loan amount must be positive');
      ...
      __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                              ...
                              'Active loan commitment not found on-chain');
      ...
      return { active_count:
                 ((t1) => {
                   if (t1 > 65535n) {
                     throw new __compactRuntime.CompactError('exposure-proof.compact line 81 char 21: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 65535');
                   }
                   return t1;
               ...
               total_exposure:
                 ((t1) => {
                   if (t1 > 18446744073709551615n) {
                     throw new __compactRuntime.CompactError('exposure-proof.compact line 82 char 23: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                   }
                   return t1;
                                 ...
                                 max_total_exposure_0)
  {
    ...
    const initial_summary_0 = { active_count: 0n, total_exposure: 0n };
    const summary_0 = this._folder_0(context,
                                     partialProofData,
                                     ((context, partialProofData, acc_0, item_0) =>
                                      {
                                        return this._process_loan_item_0(context,
                                                                         partialProofData,
                                                                         acc_0,
                                                                         item_0,
                                                                         borrower_id_0);
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_13.toValue(0n),
                                                                                                                  alignment: _descriptor_13.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(loan_commitment_0),
                                                                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'exposure-proof.compact line 28 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    nullifiers: {
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'exposure-proof.compact line 31 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
  ...
  compute_nullifier: (...args_0) => {
    ...
    if (!(commitment_0.buffer instanceof ArrayBuffer && commitment_0.BYTES_PER_ELEMENT === 1 && commitment_0.length === 32)) {
      __compactRuntime.typeError('compute_nullifier',
                                 'argument 1',
                                 'exposure-proof.compact line 53 char 1',
                                 'Bytes<32>',
                                 commitment_0)
    }
    if (!(nonce_0.buffer instanceof ArrayBuffer && nonce_0.BYTES_PER_ELEMENT === 1 && nonce_0.length === 32)) {
